...
const reducer = (state, action) => {
    ...
    switch(action.type) {
        ...
        case 'ADD_CONTACT':                                     // Action qui va nous permettre d'ajouter un contact via le formulaire de Addcontact.js
            return{
                contacts: [action.payload, ...state.contacts]  // On reprend notre state 'contacts', auquel on assigne le 'action.payload' qui est l'action de créer/ajouter un contact, au state 'contacts' déjà existant pour 
            }
