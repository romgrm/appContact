...
export class Provider extends Component {
    state = {
        ...
        /** Le Dispatch va permettre d'executer les actions du reducer avec les components. C'est donc logique d'avoir une modification du state (setState) qui renvoie le state */
        dispatch: action => {
