...
export default class Contact extends Component {
    ...
    // Fonction qui permet de faire l'inverse de show (tips: on fait une fonction flechée car les fonctions simple ne prennent pas les références)
    display = () => {
        this.setState({
    ...
    render() {
        return (
            <div className="card card-body bg-light text-center mb-3">
                <p className="h3">{this.props.Contact}&nbsp; <i style={{cursor: 'pointer'}} className="fas fa-arrow-circle-down"
