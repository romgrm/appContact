...
export default class Contact extends Component {
    ...
    deleteContact = (id, dispatch) => {
        dispatch({type: 'DELETE_CONTACT', payload: id}) // on éxécute le dispatch en lui mettant le type d'action a effectuer (on reprend l'action DELETE_CONTACT créée dans le switch de notre Reducer)
    }
