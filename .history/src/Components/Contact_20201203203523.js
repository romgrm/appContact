    ...
    render() {
        ...
        return(
            <Consumer>
                ...
                onClick={() => this.deleteContact(this.props.id, dispatch)}></i> {/** ici on utilise notre Croix pour effectué une action au clic. Cette action va appeler la fonction deleteContact() qui va prendre en paramètre l'id de notre contact (qui est dans le state) ainsi que  */}
                </p>
