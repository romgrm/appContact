...
export default class Liste extends Component {
    ...
    render() {
        return (
            // On intègre le Consumer à notre render(). On utilise 'value' qui fait référence au value de notre Provider dans Context.js, autrement dit à la valeur de notre state
            <Consumer>
                {value => {
                    return (
                        <React.Fragment>
