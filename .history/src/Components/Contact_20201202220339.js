...
export default class Contact extends Component {
    ...
    // Fonction qui permet de récupérer la fonction anonyme Delete() qui va permettre de supprimer un contact via son Id (l'id courant) et cette function va elle
    deleteContact = () => {
        this.props.Delete()
    }
