...
export default class Liste extends Component {
    ...
    onSubmit = (event) => {
        ...
        this.setState({
            nom: '',
            nom: [...this.state.nom,  this.state.nom ],
            prenom: '',
            prenom: [...this.state.prenom, this.state.prenom]
    ...
    render() {
        return (
            <React.Fragment>
                ...
                <div>
                <form>
                <input name="input" placeholder="entrer votre nom" onChange={this.onChange} value={this.state.nom}></input>
                <input name="input" placeholder="entrer votre prénom" onChange={this.onChange} value={this.state.entreeClavier}></input>                
