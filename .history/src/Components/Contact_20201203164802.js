        ...
        return (
            <div className="card card-body bg-light text-center mb-3">
                ...
                {this.state.show ? (                
                    ...
                    <li className="list-group-item"> Nom : {this.props.dataNom}</li>
                    <li className="list-group-item"> Prénom : {this.props.dataPrenom}</li>
                    <li className="list-group-item"> Mail : {this.props.dataMail}</li>
