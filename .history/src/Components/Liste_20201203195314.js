...
export default class Liste extends Component {
    ...
    render() {
        return (
            // On intègre le Consumer à notre render(). On utilise 'value' qui fait référence au value de notre Provider dans Context.js, autrement dit à la valeur de notre state, puis on return notre code qui fait appel au state
            <Consumer>
                {value => {
                    return (
                        <React.Fragment>
